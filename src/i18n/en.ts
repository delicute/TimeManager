...
export const en: Translations = {
  ...
  reminderMetricTodaySessionCount: 'Sessions Today',
  reminderMetricCurrentSessionDuration: 'Session Duration',
  reminderOperNeq: '≠',
  reminderBoolCurrentState: 'Current State',
  reminderBoolIsDebt: 'In Debt',
  reminderBoolHasActivityToday: 'Done Today',
  reminderBoolIsPaused: 'Is Paused',
  reminderBoolIsMilestoneAvailable: 'Milestone Ready',
  reminderTime: 'Time',
